...
## 23.06 종강
![image](https://github.com/chihyeonWON/Cloud_Computing/assets/58906858/ae25b8bd-9034-46fc-8d06-c036d6c194c5)
```
클라우드 서비스가 대중에게 알려진 지 얼마 안되었지만
AWS 사용법이나 클라우드 시스템에 대해서 배울 수 있었던 과목 
```
```
